...
public class Cart implements Serializable{
	...
	private final Double INIT_DOUBLE = .0;
...
//		if(mo==1){
//			if (cart == null) {
//				boolean flag = SerializationUtils.isExist(userId);
//				if(flag == true){
//					cart = SerializationUtils.getCartFromDB(userId);
//				}else{
//					cart  = new Cart();
//					SerializationUtils.setCartToDB(userId, cart);
//				}
//				cart.showCart();
////				if(cart == null){
////					cart = new Cart();
...
//		}
	...
	//getLastCart：其实就是getCart,也是Serialization.readCart(userId);
